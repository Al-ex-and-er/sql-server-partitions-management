...
('__05', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL,    5, NULL, NULL,    0, ''             ),
('__10', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL,   10,    1,    1,    1, '5'            ),
('__15', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL,   15,    1,    1,    1, '5'            ),
('__20', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL,   20,    1,    2,    3, '5,10,15'      ),
('__25', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL,   25,    1,    2,    3, '5,10,15'      ),
('____', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R', NULL, NULL,    1,    3,    5, '5,10,15,20,25'),
('0505', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5,    5, NULL, NULL,    0, ''             ),
('0510', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5,   10, NULL, NULL,    0, ''             ),
('0515', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5,   15, NULL, NULL,    0, ''             ),
('0520', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5,   20,    2,    2,    2, '10,15'        ),
('0525', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5,   25,    2,    2,    2, '10,15'        ),
('05__', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',    5, NULL,    2,    3,    4, '10,15,20,25'  ),
('1010', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   10,   10, NULL, NULL,    0, ''             ),
('1015', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   10,   15, NULL, NULL,    0, ''             ),
('1020', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   10,   20,    2,    2,    2, '10,15'        ),
('1025', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   10,   25,    2,    2,    2, '10,15'        ),
('10__', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   10, NULL,    2,    3,    4, '10,15,20,25'  ),
('1515', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   15,   15, NULL, NULL,    0, ''             ),
('1520', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   15,   20, NULL, NULL,    0, ''             ),
('1525', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   15,   25, NULL, NULL,    0, ''             ),
('15__', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   15, NULL,    3,    3,    2, '20,25'        ),
('2020', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   20,   20, NULL, NULL,    0, ''             ),
('2025', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   20,   25, NULL, NULL,    0, ''             ),
('20__', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   20, NULL,    3,    3,    2, '20,25'        ),
('2525', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   25,   25, NULL, NULL,    0, ''             ),
('25__', 'dbo.Test_Switch_R', 'dbo.Test_Switch_Temp_R',   25, NULL, NULL, NULL,    0, ''             )
...
begin
    ...
    --
    -- Switch data in the forward direction, dbo.Test_Switch_R -> dbo.Test_Switch_Temp_R
    --
    begin try
      set @err = 0
    ...
    begin
      ...
      select @actual_count = count(*) from dbo.Test_Switch_Temp_R
    ...
    --
    -- Switch data in the reverse direction, dbo.Test_Switch_Temp_R -> dbo.Test_Switch_R
    --
    print ''
    ...
    begin
      ...
      if 0 <> (select count(*) from dbo.Test_Switch_Temp_R)
      begin
      ...
      if 75 <> (select sum(c1) from dbo.Test_Switch_R)
      begin
